  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pb-20 sm:pb-0">
      ...
      <div className="text-center py-4">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800">New master</h1>
      </div>
      <MarqueeBanner />

        <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-lg shadow p-6 max-w-3xl mx-auto">
          <h2 className="text-lg font-semibold text-gray-700 border-b pb-3 mb-6">New master</h2>
